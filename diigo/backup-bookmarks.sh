...
curl "https://$DIIGO_USERNAME:$DIIGO_URL_ENCODED_PASSWORD@secure.diigo.com/api/v2/bookmarks?user=$DIIGO_USERNAME&filter=all&sort=0&count=10&start=0" | jq . >1.json
...
curl "https://$DIIGO_USERNAME:$DIIGO_URL_ENCODED_PASSWORD@secure.diigo.com/api/v2/bookmarks?user=$DIIGO_USERNAME&filter=all&sort=0&count=10&start=2" | jq . >1.json
